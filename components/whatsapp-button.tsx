...
export default function WhatsAppButton({ cartItems, customerInfo }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 bg-green-600 text-white p-4 rounded-full shadow-lg hover:bg-green-700 transition-colors duration-300 z-50 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-green-400"
